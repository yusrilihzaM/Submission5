...
import static com.yusril.favorit.database.DatabaseContract.TvColumns.DESCRIPTION_TV;
...
public class TvAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        if (cursor != null){
            ...
            ImageView image = view.findViewById(R.id.img_tv);
            movieName.setText(getColumnString(cursor,TITLE));
            TextView description=view.findViewById(R.id.tv_description);
            description.setText(getColumnString(cursor,DESCRIPTION_TV));
            Glide.with(context)
